package ch.vd.shared.tipi.engine.command;

import ch.vd.shared.tipi.engine.action.Activity;
import ch.vd.shared.tipi.engine.action.UnknownProcess;
import ch.vd.shared.tipi.engine.client.*;
import ch.vd.shared.tipi.engine.meta.ActivityMetaModel;
import ch.vd.shared.tipi.engine.meta.SubProcessMetaModel;
import ch.vd.shared.tipi.engine.meta.TopProcessMetaModel;
import ch.vd.shared.tipi.engine.meta.VariableDescription;
...
public class MetaModelHelper {
    ...
    public static ActivityModel createModelFromMeta(final ActivityMetaModel meta, final boolean isProcess,
                                                    final VariableMap vars, ActivityPersistenceService aHelperService) {
        Assert.notNull(meta);

        ActivityModel a = null;
        if (isProcess) {
            a = new TopProcessModel();
        } else if (meta instanceof SubProcessMetaModel) {
            a = new SubProcessModel();
