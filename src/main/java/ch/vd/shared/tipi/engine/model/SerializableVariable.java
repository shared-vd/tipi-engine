...
public class SerializableVariable extends Variable<Serializable> {
	...
	protected SerializableVariable() {
	}

	public SerializableVariable(String key, Serializable value, BlobFactory aBlobFactory) {
		super(key);
